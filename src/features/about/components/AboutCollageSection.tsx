...
export default function AboutCollageSection({ onOpenResume }) {
  return (
    <div className="relative w-full aspect-[762/720] rounded-2xl overflow-hidden shadow-lg border border-white/0 bg-[#0D0F15] select-none group/canvas">
      ...
      <img
        src="/assets/collage-elements/grid_bg.webp"
        alt="Grid Background"
      ...
      >
        ...
        <div className="w-full px-[4%] pt-[4%] pb-[2%] flex items-center justify-center">
          <img
            src="/assets/collage-elements/hello_world_text.webp"
            alt="hello world!"
        ...
        <div className="w-full flex-1 overflow-hidden">
          <img
            src="/assets/collage-elements/sayan_portrait.webp"
            alt="Sayan Ghosh"
      ...
      <div className="absolute inset-0 z-20 pointer-events-none">
        ...
        <div 
          ...
          title="Cat Sticker"
        >
          <img src="/assets/collage-elements/cat.webp" alt="Cat" className="w-full h-auto drop-shadow-xl" />
        </div>
        ...
        <div 
          ...
          title="Soccer Ball"
        >
          <img src="/assets/collage-elements/soccerball.webp" alt="Soccer Ball" className="w-full h-auto drop-shadow-xl" />
        </div>
        ...
        <div className="group/left-cluster absolute top-[51.67%] left-[10.63%] w-[28.35%] h-[30.5%] z-20 pointer-events-auto cursor-pointer">
          ...
          <div className="group/whatsapp-card absolute top-0 left-0 w-full h-[62%] z-20 pointer-events-auto cursor-pointer">
            ...
            <div className="w-full mt-[6.4%] transition-all duration-300 ease-out group-hover/left-cluster:scale-[1.02] group-hover/whatsapp-card:!scale-[1.06] group-hover/whatsapp-card:!-translate-y-2.5 group-hover/whatsapp-card:!rotate-2 group-hover/whatsapp-card:!drop-shadow-[0_20px_35px_rgba(46,213,115,0.4)]">
              <img src="/assets/collage-elements/speech_bubble_card.webp" alt="Speech Bubble" className="w-full h-auto drop-shadow-2xl" />
            </div>
            ...
            <div 
              ...
              title="Pushpin"
            >
              <img src="/assets/collage-elements/pushpin.webp" alt="Pushpin" className="w-full h-auto drop-shadow-md" />
            </div>
          ...
          >
            <img src="/assets/collage-elements/guitar_polaroid.webp" alt="Playing Guitar" className="w-full h-auto drop-shadow-2xl" />
          </div>
        ...
        <div className="group/photo-stack">
          ...
          <div className="group/cat-photo absolute top-[22.22%] left-[62.40%] w-[15.95%] h-[20.8%] z-25 pointer-events-auto cursor-pointer">
            ...
            <div 
              ...
              title="Cat on Laptop"
            >
              <img src="/assets/collage-elements/cat_laptop_polaroid.webp" alt="Cat Laptop" className="w-full h-auto drop-shadow-2xl" />
            </div>
            ...
            <div 
              ...
              title="Paperclip"
            >
              <img src="/assets/collage-elements/paperclip.webp" alt="Paperclip" className="w-full h-auto drop-shadow" />
            </div>
          </div>
          ...
          <div 
            ...
            title="Mountain View"
          >
            <img src="/assets/collage-elements/mountain_polaroid.webp" alt="Mountain View" className="w-full h-auto drop-shadow-2xl" />
          </div>
          ...
          <div 
            ...
            title="Food Dish"
          >
            <img src="/assets/collage-elements/food_polaroid.webp" alt="Food Dish" className="w-full h-auto drop-shadow-2xl" />
          </div>
        ...
        <div 
          ...
          title="Cookie"
        >
          <img src="/assets/collage-elements/cookie.webp" alt="Cookie" className="w-full h-auto drop-shadow-lg" />
        </div>
        ...
        <div 
          ...
          title="Coffee Cup"
        >
          <img src="/assets/collage-elements/coffee_cup.webp" alt="Coffee Cup" className="w-full h-auto drop-shadow-2xl" />
        </div>
